...
<div class="content-search classic-search-results">
...
{switch name=Sw match=$search_count}
  {case match=0}
  <div class="warning">
  <h2>{'Unfortunately, no results were found when searching for "%1" on www.nuxeo.com'|i18n('nuxeo_design/content/search', , array($search_text|wash))}</h2>
  ...
  {/if*}
  	...
  	<p>{'You might however find interesting content on our user-dedicated sites:'|i18n('nuxeo_design/content/search')}</p>
  	<ul><li>{'Search our <a href="http://doc.nuxeo.com" class="external">Documentation Center</a>'|i18n('nuxeo_design/content/search', , array('/documentation/center'))}</li>
  	<li>
  	{'Visit our <a href="http://answers.nuxeo.com" class="external">Q&A site</a> to browse questions or ask new ones'|i18n('nuxeo_design/content/search', , array('/qa'))}</li>
  	</ul>
  	<p>{'or if you specifically want to search on www.nuxeo.com:'|i18n('nuxeo_design/content/search')}</p>
    <ul>
  ...
  {case}
  <div class="feedback">
  <h2>{'Search for "%1" returned %2 matches'|i18n("nuxeo_design/content/search",,array($search_text|wash,$search_count))}</h2>
  ...
  {* NETGEN 2013-05-07 Search controls hidden through nuxeo_style.css *}
