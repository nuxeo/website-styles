      ...
      <h1>Improve your experience</h1>
        ...
        <div class="news">
          ...
          <ul>
            ...
            <li>The <a onclick="window.open(this.href); return false;" href="http://doc.nuxeo.org/xwiki/bin/view/Main/Downloads#HLiveEdit">
              Nuxeo LiveEdit
        ...
        <div class="news">
          ...
          <ul>
            <li><a onclick="window.open(this.href); return false;" href="http://doc.nuxeo.org/xwiki/bin/view/Main/QuickStart/">
              Nuxeo Quickstart</a></li>
          </ul>
        </div>
