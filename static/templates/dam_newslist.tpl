    ...
    <div class="news_block">
     ...
     -->
      <h1>Getting Started</h1>
        ...
        <div class="news">
          <ul>
            <li><a href="http://www.nuxeo.org/xwiki/bin/view/Main/Nuxeo+DAM+User+Guide+" onclick="window.open(this.href); return false;">• Latest version of the user guide for Nuxeo DAM.</a></li>
            <li><a href="http://www.nuxeo.org/discussions/forum.jspa?forumID=15&start=0" onclick="window.open(this.href); return false;">• Nuxeo Community Forum for Nuxeo DAM.</a></li>
          </ul>
        </div>
