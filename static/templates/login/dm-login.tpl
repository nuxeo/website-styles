  ...
  {literal}
    <style type="text/css">
        ...
        .button, .button:visited {
          ...
          background:url("http://static.nuxeo.com/images/overlay.png") repeat-x scroll 0 0 #262626;
    ...
    <div class="news_block">
      ...
      <h2>Next Steps</h2>
        ...
        <div class="news links">
          ...
          <p><span>Comprehensive subscription support offering</span><a class="button small" target="_blank" href="http://www.nuxeo.com/en/subscription/connect?utm_source=dm&utm_medium=login-page&utm_campaign=products" onclick="javascript:pageTracker._trackPageview('/external/connect/');">Nuxeo Connect</a></p>
          <div style="clear:both;"></div>
        ...
        <div class="news links">
          ...
          <div style="clear:both;"></div>
          <p><span>Get insight into ECM issues</span> <a class="button small" target="_blank" href="http://blogs.nuxeo.com?utm_source=dm&utm_medium=login-page&utm_campaign=products" onclick="javascript:pageTracker._trackPageview('/external/blogs/');">Blogs</a></p>
          <div style="clear:both;"></div>
